		...
		function mountWindowChrome() {
			...
			function ensureStyle() {
				...
				st.textContent =
					...
					"z-index:2147483647;--wails-draggable:drag;display:none}" +
			...
			function isSwitching() {
				const sh = document.querySelector('[data-dsh-surface="session-header"]');
				return !!(sh && sh.querySelector('header[aria-hidden="true"]'));
			}

			function sync() {
				const host = document.querySelector("[data-dsh-center-col]");
